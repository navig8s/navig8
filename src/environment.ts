...
export const COPYRIGHT = import.meta.env.NAVIG8_COPYRIGHT ?? window._env_?.NAVIG8_COPYRIGHT
export const BASE_URL = import.meta.env.NAVIG8_BASE_URL ?? window._env_?.NAVIG8_BASE_URL ?? '/'
